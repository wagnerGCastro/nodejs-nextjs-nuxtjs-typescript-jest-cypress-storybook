...
<template>
  <v-app>
    <v-navigation-drawer v-model="sideNavigationActive" app color="primary" left absolute dark>
    ...
    <v-app-bar app>
      <v-app-bar-nav-icon @click="sideNavigationActive = !sideNavigationActive" />
