...
<head>
    <title>Code coverage report for www/_node_modules/@babel/types/lib/definitions/core.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../../index.html">All files</a> / <a href="index.html">www/_node_modules/@babel/types/lib/definitions</a> core.js</h1>
        <div class='clearfix'>
...
<a name='L1649'></a><a href='#L1649'>1649</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >exports.patternLikeCommon = exports.functionTypeAnnotationCommon = exports.functionDeclarationCommon = exports.functionCommon = exports.classMethodOrPropertyCommon = exports.classMethodOrDeclareMethodCommon = void 0;</span>
&nbsp;
...
&nbsp;
var _helperValidatorIdentifier = <span class="cstat-no" title="statement not covered" >require("@babel/helper-validator-identifier");</span>
&nbsp;
var _constants = <span class="cstat-no" title="statement not covered" >require("../constants");</span>
&nbsp;
var _utils = <span class="cstat-no" title="statement not covered" >require("./utils");</span>
&nbsp;
const defineType = <span class="cstat-no" title="statement not covered" >(0, _utils.defineAliasedType)("Standardized");</span>
<span class="cstat-no" title="statement not covered" >defineType("ArrayExpression", {</span>
  fields: {
    elements: {
...
<span class="cstat-no" title="statement not covered" >defineType("AssignmentExpression", {</span>
  fields: {
    operator: {
      validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) {</span>
<span class="cstat-no" title="statement not covered" >          return (0, _utils.assertValueType)("string");</span>
        }
&nbsp;
        const identifier = <span class="cstat-no" title="statement not covered" >(0, _utils.assertOneOf)(..._constants.ASSIGNMENT_OPERATORS);</span>
        const pattern = <span class="cstat-no" title="statement not covered" >(0, _utils.assertOneOf)("=");</span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
          const validator = <span class="cstat-no" title="statement not covered" >(0, _is.default)("Pattern", node.left) ? pattern : identifier;</span>
<span class="cstat-no" title="statement not covered" >          validator(node, key, val);</span>
        };
      }()
    },
    left: {
...
<span class="cstat-no" title="statement not covered" >defineType("BinaryExpression", {</span>
  builder: ["operator", "left", "right"],
  fields: {
    operator: {
    ...
    left: {
      validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
        const expression = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Expression");</span>
        const inOp = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Expression", "PrivateName");</span>
&nbsp;
        const validator = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
          const validator = <span class="cstat-no" title="statement not covered" >node.operator === "in" ? inOp : expression;</span>
<span class="cstat-no" title="statement not covered" >          validator(node, key, val);</span>
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        validator.oneOfNodeTypes = ["Expression", "PrivateName"];</span>
...
<span class="cstat-no" title="statement not covered" >defineType("InterpreterDirective", {</span>
  builder: ["value"],
  fields: {
    value: {
...
<span class="cstat-no" title="statement not covered" >defineType("Directive", {</span>
  visitor: ["value"],
  fields: {
    value: {
...
<span class="cstat-no" title="statement not covered" >defineType("DirectiveLiteral", {</span>
  builder: ["value"],
  fields: {
    value: {
      validate: (0, _utils.assertValueType)("string")
...
<span class="cstat-no" title="statement not covered" >defineType("BlockStatement", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("BreakStatement", {</span>
  visitor: ["label"],
  fields: {
    label: {
...
<span class="cstat-no" title="statement not covered" >defineType("CallExpression", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("CatchClause", {</span>
  visitor: ["param", "body"],
  fields: {
    param: {
...
<span class="cstat-no" title="statement not covered" >defineType("ConditionalExpression", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ContinueStatement", {</span>
  visitor: ["label"],
  fields: {
    label: {
      validate: (0, _utils.assertNodeType)("Identifier"),
...
<span class="cstat-no" title="statement not covered" >defineType("DebuggerStatement", {</span>
  aliases: ["Statement"]
});
<span class="cstat-no" title="statement not covered" >defineType("DoWhileStatement", {</span>
  visitor: ["test", "body"],
  fields: {
    test: {
      validate: (0, _utils.assertNodeType)("Expression")
...
<span class="cstat-no" title="statement not covered" >defineType("EmptyStatement", {</span>
  aliases: ["Statement"]
});
<span class="cstat-no" title="statement not covered" >defineType("ExpressionStatement", {</span>
  visitor: ["expression"],
  fields: {
    expression: {
      validate: (0, _utils.assertNodeType)("Expression")
...
<span class="cstat-no" title="statement not covered" >defineType("File", {</span>
  ...
  fields: {
    ...
    comments: {
      validate: !process.env.BABEL_TYPES_8_BREAKING ? Object.assign(<span class="fstat-no" title="function not covered" >()</span> =&gt; {}, {
        each: {
    ...
    tokens: {
      validate: (0, _utils.assertEach)(Object.assign(<span class="fstat-no" title="function not covered" >()</span> =&gt; {}, {
        type: "any"
      })),
      optional: true
    }
...
<span class="cstat-no" title="statement not covered" >defineType("ForInStatement", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ForStatement", {</span>
...
const functionCommon = <span class="cstat-no" title="statement not covered" >{</span>
  params: {
...
<span class="cstat-no" title="statement not covered" >exports.functionCommon = functionCommon;</span>
const functionTypeAnnotationCommon = <span class="cstat-no" title="statement not covered" >{</span>
  returnType: {
...
<span class="cstat-no" title="statement not covered" >exports.functionTypeAnnotationCommon = functionTypeAnnotationCommon;</span>
const functionDeclarationCommon = <span class="cstat-no" title="statement not covered" >Object.assign({}, functionCommon, {</span>
  declare: {
...
<span class="cstat-no" title="statement not covered" >exports.functionDeclarationCommon = functionDeclarationCommon;</span>
<span class="cstat-no" title="statement not covered" >defineType("FunctionDeclaration", {</span>
  ...
  validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >    if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >()</span> =&gt; {};</span></span>
    const identifier = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier");</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >fu</span>nction (parent, key, node) {</span>
<span class="cstat-no" title="statement not covered" >      if (!(0, _is.default)("ExportDefaultDeclaration", parent)) {</span>
<span class="cstat-no" title="statement not covered" >        identifier(node, "id", node.id);</span>
      }
    };
  }()
});
<span class="cstat-no" title="statement not covered" >defineType("FunctionExpression", {</span>
...
const patternLikeCommon = <span class="cstat-no" title="statement not covered" >{</span>
  typeAnnotation: {
    validate: (0, _utils.assertNodeType)("TypeAnnotation", "TSTypeAnnotation", "Noop"),
    optional: true
  },
...
<span class="cstat-no" title="statement not covered" >exports.patternLikeCommon = patternLikeCommon;</span>
<span class="cstat-no" title="statement not covered" >defineType("Identifier", {</span>
  builder: ["name"],
  visitor: ["typeAnnotation", "decorators"],
  aliases: ["Expression", "PatternLike", "LVal", "TSEntityName"],
  fields: Object.assign({}, patternLikeCommon, {
    name: {
      validate: (0, _utils.chain)((0, _utils.assertValueType)("string"), Object.assign(<span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(0, _isValidIdentifier.default)(val, false)) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError(`"${val}" is not a valid identifier name`);</span>
        }
      }, {
        type: "string"
      }))
...
&nbsp;
<span class="fstat-no" title="function not covered" >  va</span>lidate(parent, key, node) {
<span class="cstat-no" title="statement not covered" >    if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
    const match = <span class="cstat-no" title="statement not covered" >/\.(\w+)$/.exec(key);</span>
<span class="cstat-no" title="statement not covered" >    if (!match) <span class="cstat-no" title="statement not covered" >return;</span></span>
    const [, parentKey] = <span class="cstat-no" title="statement not covered" >match;</span>
    const nonComp = <span class="cstat-no" title="statement not covered" >{</span>
      computed: false
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (parentKey === "property") {</span>
<span class="cstat-no" title="statement not covered" >      if ((0, _is.default)("MemberExpression", parent, nonComp)) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >      if ((0, _is.default)("OptionalMemberExpression", parent, nonComp)) <span class="cstat-no" title="statement not covered" >return;</span></span>
    } else <span class="cstat-no" title="statement not covered" >if (parentKey === "key") {</span>
<span class="cstat-no" title="statement not covered" >      if ((0, _is.default)("Property", parent, nonComp)) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >      if ((0, _is.default)("Method", parent, nonComp)) <span class="cstat-no" title="statement not covered" >return;</span></span>
    } else <span class="cstat-no" title="statement not covered" >if (parentKey === "exported") {</span>
<span class="cstat-no" title="statement not covered" >      if ((0, _is.default)("ExportSpecifier", parent)) <span class="cstat-no" title="statement not covered" >return;</span></span>
    } else <span class="cstat-no" title="statement not covered" >if (parentKey === "imported") {</span>
<span class="cstat-no" title="statement not covered" >      if ((0, _is.default)("ImportSpecifier", parent, {</span>
        imported: node
      })) <span class="cstat-no" title="statement not covered" >return;</span>
    } else <span class="cstat-no" title="statement not covered" >if (parentKey === "meta") {</span>
<span class="cstat-no" title="statement not covered" >      if ((0, _is.default)("MetaProperty", parent, {</span>
        meta: node
      })) <span class="cstat-no" title="statement not covered" >return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (((0, _helperValidatorIdentifier.isKeyword)(node.name) || (0, _helperValidatorIdentifier.isReservedWord)(node.name, false)) &amp;&amp; node.name !== "this") {</span>
<span class="cstat-no" title="statement not covered" >      throw new TypeError(`"${node.name}" is not a valid identifier`);</span>
    }
  }
&nbsp;
});
<span class="cstat-no" title="statement not covered" >defineType("IfStatement", {</span>
  visitor: ["test", "consequent", "alternate"],
...
<span class="cstat-no" title="statement not covered" >defineType("LabeledStatement", {</span>
  visitor: ["label", "body"],
  aliases: ["Statement"],
  fields: {
    label: {
...
<span class="cstat-no" title="statement not covered" >defineType("StringLiteral", {</span>
  builder: ["value"],
  fields: {
    value: {
      validate: (0, _utils.assertValueType)("string")
...
<span class="cstat-no" title="statement not covered" >defineType("NumericLiteral", {</span>
  builder: ["value"],
...
<span class="cstat-no" title="statement not covered" >defineType("NullLiteral", {</span>
  aliases: ["Expression", "Pureish", "Literal", "Immutable"]
});
<span class="cstat-no" title="statement not covered" >defineType("BooleanLiteral", {</span>
  builder: ["value"],
  fields: {
    value: {
      validate: (0, _utils.assertValueType)("boolean")
...
<span class="cstat-no" title="statement not covered" >defineType("RegExpLiteral", {</span>
  ...
  fields: {
    ...
    flags: {
      validate: (0, _utils.chain)((0, _utils.assertValueType)("string"), Object.assign(<span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
        const invalid = <span class="cstat-no" title="statement not covered" >/[^gimsuy]/.exec(val);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (invalid) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError(`"${invalid[0]}" is not a valid RegExp flag`);</span>
        }
      }, {
        type: "string"
      })),
...
<span class="cstat-no" title="statement not covered" >defineType("LogicalExpression", {</span>
  builder: ["operator", "left", "right"],
  visitor: ["left", "right"],
  aliases: ["Binary", "Expression"],
  fields: {
...
<span class="cstat-no" title="statement not covered" >defineType("MemberExpression", {</span>
  ...
  fields: Object.assign({
    ...
    property: {
      validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
        const normal = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier", "PrivateName");</span>
        const computed = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Expression");</span>
&nbsp;
        const validator = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
          const validator = <span class="cstat-no" title="statement not covered" >node.computed ? computed : normal;</span>
<span class="cstat-no" title="statement not covered" >          validator(node, key, val);</span>
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        validator.oneOfNodeTypes = ["Expression", "Identifier", "PrivateName"];</span>
<span class="cstat-no" title="statement not covered" >        return validator;</span>
      }()
    },
    computed: {
...
<span class="cstat-no" title="statement not covered" >defineType("NewExpression", {</span>
  inherits: "CallExpression"
});
<span class="cstat-no" title="statement not covered" >defineType("Program", {</span>
  visitor: ["directives", "body"],
...
<span class="cstat-no" title="statement not covered" >defineType("ObjectExpression", {</span>
  visitor: ["properties"],
  aliases: ["Expression"],
  fields: {
    properties: {
...
<span class="cstat-no" title="statement not covered" >defineType("ObjectMethod", {</span>
  ...
  fields: Object.assign({}, functionCommon, functionTypeAnnotationCommon, {
    ...
    key: {
      validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
        const normal = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral");</span>
        const computed = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Expression");</span>
&nbsp;
        const validator = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
          const validator = <span class="cstat-no" title="statement not covered" >node.computed ? computed : normal;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        validator.oneOfNodeTypes = ["Expression", "Identifier", "StringLiteral", "NumericLiteral"];</span>
<span class="cstat-no" title="statement not covered" >        return validator;</span>
      }()
    },
    decorators: {
...
<span class="cstat-no" title="statement not covered" >defineType("ObjectProperty", {</span>
...
<span class="cstat-no" title="statement not covered" >        return validator;</span>
    ...
    shorthand: {
      validate: (0, _utils.chain)((0, _utils.assertValueType)("boolean"), Object.assign(<span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (val &amp;&amp; node.computed) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError("Property shorthand of ObjectProperty cannot be true if computed is true");</span>
        }
      }, {
        type: "boolean"
      }), <span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (val &amp;&amp; !(0, _is.default)("Identifier", node.key)) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError("Property shorthand of ObjectProperty cannot be true if key is not an Identifier");</span>
        }
      }),
      default: false
    },
  ...
  validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
    const pattern = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier", "Pattern");</span>
    const expression = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Expression");</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >fu</span>nction (parent, key, node) {</span>
<span class="cstat-no" title="statement not covered" >      if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
      const validator = <span class="cstat-no" title="statement not covered" >(0, _is.default)("ObjectPattern", parent) ? pattern : expression;</span>
<span class="cstat-no" title="statement not covered" >      validator(node, "value", node.value);</span>
    };
  }()
});
<span class="cstat-no" title="statement not covered" >defineType("RestElement", {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  va</span>lidate(parent, key) {
<span class="cstat-no" title="statement not covered" >    if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
    const match = <span class="cstat-no" title="statement not covered" >/(\w+)\[(\d+)\]/.exec(key);</span>
<span class="cstat-no" title="statement not covered" >    if (!match) <span class="cstat-no" title="statement not covered" >throw new Error("Internal Babel error: malformed key.");</span></span>
    const [, listKey, index] = <span class="cstat-no" title="statement not covered" >match;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (parent[listKey].length &gt; index + 1) {</span>
<span class="cstat-no" title="statement not covered" >      throw new TypeError(`RestElement must be last element of ${listKey}`);</span>
    }
  }
&nbsp;
});
<span class="cstat-no" title="statement not covered" >defineType("ReturnStatement", {</span>
  visitor: ["argument"],
  aliases: ["Statement", "Terminatorless", "CompletionStatement"],
  fields: {
    argument: {
...
<span class="cstat-no" title="statement not covered" >defineType("SequenceExpression", {</span>
  visitor: ["expressions"],
  fields: {
    expressions: {
...
<span class="cstat-no" title="statement not covered" >defineType("ParenthesizedExpression", {</span>
  visitor: ["expression"],
...
<span class="cstat-no" title="statement not covered" >defineType("SwitchCase", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("SwitchStatement", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ThisExpression", {</span>
  aliases: ["Expression"]
});
<span class="cstat-no" title="statement not covered" >defineType("ThrowStatement", {</span>
  visitor: ["argument"],
  aliases: ["Statement", "Terminatorless", "CompletionStatement"],
  fields: {
    argument: {
...
<span class="cstat-no" title="statement not covered" >defineType("TryStatement", {</span>
  visitor: ["block", "handler", "finalizer"],
  aliases: ["Statement"],
  fields: {
    block: {
      validate: (0, _utils.chain)((0, _utils.assertNodeType)("BlockStatement"), Object.assign(<span class="fstat-no" title="function not covered" >fu</span>nction (node) {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!node.handler &amp;&amp; !node.finalizer) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError("TryStatement expects either a handler or finalizer, or both");</span>
        }
      }, {
...
<span class="cstat-no" title="statement not covered" >defineType("UnaryExpression", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("UpdateExpression", {</span>
  builder: ["operator", "argument", "prefix"],
  fields: {
    prefix: {
      default: false
...
<span class="cstat-no" title="statement not covered" >defineType("VariableDeclaration", {</span>
...
<span class="fstat-no" title="function not covered" >  va</span>lidate(parent, key, node) {
<span class="cstat-no" title="statement not covered" >    if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >    if (!(0, _is.default)("ForXStatement", parent, {</span>
      left: node
    })) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (node.declarations.length !== 1) {</span>
<span class="cstat-no" title="statement not covered" >      throw new TypeError(`Exactly one VariableDeclarator is required in the VariableDeclaration of a ${parent.type}`);</span>
    }
  }
&nbsp;
});
<span class="cstat-no" title="statement not covered" >defineType("VariableDeclarator", {</span>
  visitor: ["id", "init"],
  fields: {
    id: {
      validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) {</span>
<span class="cstat-no" title="statement not covered" >          return (0, _utils.assertNodeType)("LVal");</span>
        }
&nbsp;
        const normal = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier", "ArrayPattern", "ObjectPattern");</span>
        const without = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier");</span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
          const validator = <span class="cstat-no" title="statement not covered" >node.init ? normal : without;</span>
<span class="cstat-no" title="statement not covered" >          validator(node, key, val);</span>
        };
      }()
    },
...
<span class="cstat-no" title="statement not covered" >defineType("WhileStatement", {</span>
  visitor: ["test", "body"],
  aliases: ["Statement", "BlockParent", "Loop", "While", "Scopable"],
  fields: {
    test: {
...
<span class="cstat-no" title="statement not covered" >defineType("WithStatement", {</span>
  visitor: ["object", "body"],
  aliases: ["Statement"],
  fields: {
    object: {
...
<span class="cstat-no" title="statement not covered" >defineType("AssignmentPattern", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ArrayPattern", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ArrowFunctionExpression", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ClassBody", {</span>
  visitor: ["body"],
  fields: {
    body: {
...
<span class="cstat-no" title="statement not covered" >defineType("ClassExpression", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ClassDeclaration", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ExportAllDeclaration", {</span>
  visitor: ["source"],
...
<span class="cstat-no" title="statement not covered" >defineType("ExportDefaultDeclaration", {</span>
  visitor: ["declaration"],
  aliases: ["Statement", "Declaration", "ModuleDeclaration", "ExportDeclaration"],
  fields: {
    declaration: {
...
<span class="cstat-no" title="statement not covered" >defineType("ExportNamedDeclaration", {</span>
  visitor: ["declaration", "specifiers", "source"],
  aliases: ["Statement", "Declaration", "ModuleDeclaration", "ExportDeclaration"],
  fields: {
    declaration: {
      optional: true,
      validate: (0, _utils.chain)((0, _utils.assertNodeType)("Declaration"), Object.assign(<span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (val &amp;&amp; node.specifiers.length) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError("Only declaration or specifiers is allowed on ExportNamedDeclaration");</span>
        }
      }, {
...
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (val &amp;&amp; node.source) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError("Cannot export a declaration from a source");</span>
        }
      })
    },
    assertions: {
    ...
    specifiers: {
      default: [],
      validate: (0, _utils.chain)((0, _utils.assertValueType)("array"), (0, _utils.assertEach)(<span class="fstat-no" title="function not covered" >fu</span>nction () {
        const sourced = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("ExportSpecifier", "ExportDefaultSpecifier", "ExportNamespaceSpecifier");</span>
        const sourceless = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("ExportSpecifier");</span>
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return sourced;</span></span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
          const validator = <span class="cstat-no" title="statement not covered" >node.source ? sourced : sourceless;</span>
<span class="cstat-no" title="statement not covered" >          validator(node, key, val);</span>
        };
      }()))
    },
...
<span class="cstat-no" title="statement not covered" >defineType("ExportSpecifier", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ForOfStatement", {</span>
  visitor: ["left", "right", "body"],
  ...
  fields: {
    left: {
      validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) {</span>
<span class="cstat-no" title="statement not covered" >          return (0, _utils.assertNodeType)("VariableDeclaration", "LVal");</span>
        }
&nbsp;
        const declaration = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("VariableDeclaration");</span>
        const lval = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier", "MemberExpression", "ArrayPattern", "ObjectPattern");</span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
<span class="cstat-no" title="statement not covered" >          if ((0, _is.default)("VariableDeclaration", val)) {</span>
<span class="cstat-no" title="statement not covered" >            declaration(node, key, val);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            lval(node, key, val);</span>
          }
        };
      }()
    },
...
<span class="cstat-no" title="statement not covered" >defineType("ImportDeclaration", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ImportDefaultSpecifier", {</span>
  visitor: ["local"],
  aliases: ["ModuleSpecifier"],
  fields: {
    local: {
...
<span class="cstat-no" title="statement not covered" >defineType("ImportNamespaceSpecifier", {</span>
  visitor: ["local"],
  aliases: ["ModuleSpecifier"],
  fields: {
    local: {
...
<span class="cstat-no" title="statement not covered" >defineType("ImportSpecifier", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("MetaProperty", {</span>
  visitor: ["meta", "property"],
  aliases: ["Expression"],
  fields: {
    meta: {
      validate: (0, _utils.chain)((0, _utils.assertNodeType)("Identifier"), Object.assign(<span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
        let property;
&nbsp;
<span class="cstat-no" title="statement not covered" >        switch (val.name) {</span>
          case "function":
<span class="cstat-no" title="statement not covered" >            property = "sent";</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case "new":
<span class="cstat-no" title="statement not covered" >            property = "target";</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case "import":
<span class="cstat-no" title="statement not covered" >            property = "meta";</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!(0, _is.default)("Identifier", node.property, {</span>
          name: property
        })) {
<span class="cstat-no" title="statement not covered" >          throw new TypeError("Unrecognised MetaProperty");</span>
        }
      }, {
...
const classMethodOrPropertyCommon = <span class="cstat-no" title="statement not covered" >{</span>
  abstract: {
    validate: (0, _utils.assertValueType)("boolean"),
    optional: true
  },
  ...
  key: {
    validate: (0, _utils.chain)(<span class="fstat-no" title="function not covered" >fu</span>nction () {
      const normal = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral");</span>
      const computed = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Expression");</span>
<span class="cstat-no" title="statement not covered" >      return <span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
        const validator = <span class="cstat-no" title="statement not covered" >node.computed ? computed : normal;</span>
...
<span class="cstat-no" title="statement not covered" >exports.classMethodOrPropertyCommon = classMethodOrPropertyCommon;</span>
const classMethodOrDeclareMethodCommon = <span class="cstat-no" title="statement not covered" >Object.assign({}, functionCommon, classMethodOrPropertyCommon, {</span>
  params: {
...
<span class="cstat-no" title="statement not covered" >exports.classMethodOrDeclareMethodCommon = classMethodOrDeclareMethodCommon;</span>
<span class="cstat-no" title="statement not covered" >defineType("ClassMethod", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ObjectPattern", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("SpreadElement", {</span>
  visitor: ["argument"],
  aliases: ["UnaryLike"],
...
<span class="cstat-no" title="statement not covered" >defineType("Super", {</span>
  aliases: ["Expression"]
});
<span class="cstat-no" title="statement not covered" >defineType("TaggedTemplateExpression", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("TemplateElement", {</span>
  builder: ["value", "tail"],
  fields: {
    value: {
...
<span class="cstat-no" title="statement not covered" >defineType("TemplateLiteral", {</span>
  ...
  fields: {
    ...
    expressions: {
      validate: (0, _utils.chain)((0, _utils.assertValueType)("array"), (0, _utils.assertEach)((0, _utils.assertNodeType)("Expression", "TSType")), <span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {
<span class="cstat-no" title="statement not covered" >        if (node.quasis.length !== val.length + 1) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError(`Number of ${node.type} quasis should be exactly one more than the number of expressions.\nExpected ${val.length + 1} quasis but got ${node.quasis.length}`);</span>
        }
      })
    }
  }
});
<span class="cstat-no" title="statement not covered" >defineType("YieldExpression", {</span>
...
<span class="cstat-no" title="statement not covered" >        if (!process.env.BABEL_TYPES_8_BREAKING) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (val &amp;&amp; !node.argument) {</span>
<span class="cstat-no" title="statement not covered" >          throw new TypeError("Property delegate of YieldExpression cannot be true if there is no argument");</span>
        }
      }, {
        type: "boolean"
      })),
...
<span class="cstat-no" title="statement not covered" >defineType("AwaitExpression", {</span>
  builder: ["argument"],
  visitor: ["argument"],
  aliases: ["Expression", "Terminatorless"],
  fields: {
...
<span class="cstat-no" title="statement not covered" >defineType("Import", {</span>
  aliases: ["Expression"]
});
<span class="cstat-no" title="statement not covered" >defineType("BigIntLiteral", {</span>
  builder: ["value"],
  fields: {
    value: {
      validate: (0, _utils.assertValueType)("string")
...
<span class="cstat-no" title="statement not covered" >defineType("ExportNamespaceSpecifier", {</span>
  visitor: ["exported"],
  aliases: ["ModuleSpecifier"],
  fields: {
    exported: {
...
<span class="cstat-no" title="statement not covered" >defineType("OptionalMemberExpression", {</span>
  ...
  fields: {
    ...
    property: {
      validate: <span class="fstat-no" title="function not covered" >fu</span>nction () {
        const normal = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier");</span>
        const computed = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Expression");</span>
&nbsp;
        const validator = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
          const validator = <span class="cstat-no" title="statement not covered" >node.computed ? computed : normal;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        validator.oneOfNodeTypes = ["Expression", "Identifier"];</span>
<span class="cstat-no" title="statement not covered" >        return validator;</span>
      }()
    },
    computed: {
...
<span class="cstat-no" title="statement not covered" >defineType("OptionalCallExpression", {</span>
  visitor: ["callee", "arguments", "typeParameters", "typeArguments"],
...
<span class="cstat-no" title="statement not covered" >defineType("ClassProperty", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ClassAccessorProperty", {</span>
  visitor: ["key", "value", "typeAnnotation", "decorators"],
  builder: ["key", "value", "typeAnnotation", "decorators", "computed", "static"],
  ...
  fields: Object.assign({}, classMethodOrPropertyCommon, {
    key: {
      validate: (0, _utils.chain)(<span class="fstat-no" title="function not covered" >fu</span>nction () {
        const normal = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral", "PrivateName");</span>
        const computed = <span class="cstat-no" title="statement not covered" >(0, _utils.assertNodeType)("Expression");</span>
<span class="cstat-no" title="statement not covered" >        return <span class="fstat-no" title="function not covered" >fu</span>nction (node, key, val) {</span>
          const validator = <span class="cstat-no" title="statement not covered" >node.computed ? computed : normal;</span>
<span class="cstat-no" title="statement not covered" >          validator(node, key, val);</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ClassPrivateProperty", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("ClassPrivateMethod", {</span>
...
<span class="cstat-no" title="statement not covered" >defineType("PrivateName", {</span>
  visitor: ["id"],
  aliases: ["Private"],
  fields: {
    id: {
...
<span class="cstat-no" title="statement not covered" >defineType("StaticBlock", {</span>
  visitor: ["body"],
  fields: {
    body: {
      validate: (0, _utils.chain)((0, _utils.assertValueType)("array"), (0, _utils.assertEach)((0, _utils.assertNodeType)("Statement")))
