...
<head>
    <title>Code coverage report for www/_node_modules/@nuxt/components/dist/index.d.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../../index.html">All files</a> / <a href="index.html">www/_node_modules/@nuxt/components/dist</a> index.d.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Module } from '@nuxt/types/config';
&nbsp;
interface Component {
    pascalName: string;
    kebabName: string;
