...
<head>
    <title>Code coverage report for www/_node_modules/@istanbuljs/schema/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">www/_node_modules/@istanbuljs/schema</a> index.js</h1>
        <div class='clearfix'>
...
<a name='L467'></a><a href='#L467'>467</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
const defaultExclude = <span class="cstat-no" title="statement not covered" >require('./default-exclude.js');</span>
const defaultExtension = <span class="cstat-no" title="statement not covered" >require('./default-extension.js');</span>
&nbsp;
const nycCommands = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
const cwd = <span class="cstat-no" title="statement not covered" >{</span>
	description: 'working directory used when resolving paths',
	type: 'string',
<span class="fstat-no" title="function not covered" >	ge</span>t default() {
<span class="cstat-no" title="statement not covered" >		return process.cwd();</span>
	},
	nycCommands: nycCommands.all
};
&nbsp;
const nycrcPath = <span class="cstat-no" title="statement not covered" >{</span>
	description: 'specify an explicit path to find nyc configuration',
	nycCommands: nycCommands.all
};
&nbsp;
const tempDir = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
const testExclude = <span class="cstat-no" title="statement not covered" >{</span>
	exclude: {
...
&nbsp;
const instrumentVisitor = <span class="cstat-no" title="statement not covered" >{</span>
	coverageVariable: {
...
&nbsp;
const instrumentParseGen = <span class="cstat-no" title="statement not covered" >{</span>
	autoWrap: {
...
&nbsp;
const checkCoverage = <span class="cstat-no" title="statement not covered" >{</span>
	excludeAfterRemap: {
...
&nbsp;
const nycMain = <span class="cstat-no" title="statement not covered" >{</span>
	silent: {
...
&nbsp;
const instrumentOnly = <span class="cstat-no" title="statement not covered" >{</span>
	inPlace: {
...
&nbsp;
const nyc = <span class="cstat-no" title="statement not covered" >{</span>
...
&nbsp;
function <span class="fstat-no" title="function not covered" >defaultsReducer(</span>defaults, [name, {default: value}]) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >	return Object.assign(defaults, {[name]: value});</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" >module.exports = {</span>
	...configs,
	defaults: Object.keys(configs).reduce(
<span class="fstat-no" title="function not covered" >		(d</span>efaults, id) =&gt; {
<span class="cstat-no" title="statement not covered" >			Object.defineProperty(defaults, id, {</span>
				enumerable: true,
<span class="fstat-no" title="function not covered" >				ge</span>t() {
					/* This defers `process.cwd()` until defaults are requested. */
<span class="cstat-no" title="statement not covered" >					return Object.entries(configs[id].properties)</span>
						.filter(<span class="fstat-no" title="function not covered" >([</span>, info]) =&gt; <span class="cstat-no" title="statement not covered" >'default' in info)</span>
